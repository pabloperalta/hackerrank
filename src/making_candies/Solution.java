    ...
    private static Purchase getMinimizingPurchase(long machines, long workers, long goal, long currentCandy, List<Purchase> purchases) {
        ...
        for (Purchase purchase : purchases) {
            ...
            if (currentProduction > 0) {
                ...
                System.out.println("If do this purchase, i would start at ["+candyAfterPurchase+"] and produce ["+currentProduction+"] candies per turn. Reaching ["+goal+"] would take ["+n+"] passes");
                if (n < min) {
                    min = n;
...
public class Solution {
    private static InputStream getSource() {
        try {
            return new FileInputStream(".\\src\\making_candies\\input\\input02.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(".\\src\\making_candies\\output.txt"));
